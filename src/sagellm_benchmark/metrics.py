...
class BenchmarkMetrics:
    ...
    def aggregate(cls, responses: list[Any]) -> BenchmarkMetrics:
        ...
        metrics.avg_throughput_tps = sum(metrics.throughput_samples) / len(metrics.throughput_samples)
        ...
        metrics.prefix_hit_rate = sum(r.metrics.prefix_hit_rate for r in successful) / len(successful)
        ...
        # Compression
        metrics.spec_accept_rate = sum(r.metrics.spec_accept_rate for r in successful) / len(successful)
