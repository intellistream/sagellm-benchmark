...
class BenchmarkRunner:
    ...
    async def _run_workload(self, workload: WorkloadConfig) -> BenchmarkMetrics:
        ...
        try:
            ...
            logger.error("sagellm_protocol not installed. Install with: pip install isagellm-protocol")
            raise
...
async def run_year1_benchmark(engine: Any, output_dir: Path | str = Path("./benchmark_results")) -> dict[str, BenchmarkMetrics]:
